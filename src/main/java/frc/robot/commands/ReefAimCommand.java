...
public class ReefAimCommand extends Command {
    ...
    public void initialize() {
        currentTag = LimelightHelpers.getFiducialID("yetilime");
        Translation2d reefCenter = AllianceFlipUtil.apply(FieldConstants.Reef);
        poseAimRequest.setTargetPoint(reefCenter);
    }
