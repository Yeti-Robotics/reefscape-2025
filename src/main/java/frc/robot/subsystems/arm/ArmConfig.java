...
class ArmConfig {
    ...
    static final TalonFXConfiguration armMotorConfig = new TalonFXConfiguration()
    ...
    static final CANcoderConfiguration armCanCoderConfig = new CANcoderConfiguration()
