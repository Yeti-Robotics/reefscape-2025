...
public enum CoralManipulatorState {
    GROUND_INTAKE(ArmPosition.GROUND, ElevatorPosition.BOTTOM, GrabberState.ROLL_IN, WristPosition.UNSAFE),
    L1(ArmPosition.POS_L1, ElevatorPosition.POS_L1, GrabberState.OFF, WristPosition.UNSAFE),
    SCORE_L1(ArmPosition.POS_L1, ElevatorPosition.POS_L1, GrabberState.ROLL_OUT, WristPosition.UNSAFE),
    ...
    ALGAE_HIGH(ArmPosition.POS_L3, ElevatorPosition.POS_L3, GrabberState.ROLL_IN, WristPosition.UNSAFE);
